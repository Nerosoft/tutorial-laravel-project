...
<div class="mb-3">
    ...
    type="text" class="form-control" id="name" name="name" value="{{$test?->getName()??''}}" placeholder="{{$lang->hint1}}">
</div>
<div class="mb-3">
    ...
    type="text" class="form-control" id="shortcut" name="shortcut" value="{{$test?->getShortcut()??''}}" placeholder="{{$lang->hint3}}">
</div>
<div class="mb-3">
    ...
    type="number" class="form-control" id="price" min="0" name="price" value="{{$test?->getPrice()??''}}" placeholder="{{$lang->hint2}}">
</div>
<div class="mb-3">
