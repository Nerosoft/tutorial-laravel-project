    ...
    <div class="row">
        <div class="col-lg-auto pt-2">
            <div class="input-group">
                ...
                id="brance-rays-name" type="text" class="form-control" name="brance_rays_name" value="{{$brance_rays_name??$branch->getName()}}" title="{{$lang->hint1}}" placeholder="{{$lang->hint1}}">
            </div>
        </div>
        <div class="col-lg-auto pt-2">
            <div class="input-group">
                ...
                id="brance-rays-phone" inputmode="tel" class="form-control" name="brance_rays_phone" value="{{$brance_rays_phone??$branch->getPhone()}}" title="{{$lang->hint2}}" placeholder="{{ $lang->hint2 }}">
            </div>
        </div>
        <div class="col-lg-auto pt-2">
            <div class="input-group">
                <div class="input-group-prepend">
                    ...
                    id="brance-rays-country" type="text" class="form-control" name="brance_rays_country" value="{{$brance_rays_country??$branch->getCountry()}}" title="{{$lang->hint3}}" placeholder="{{ $lang->hint3 }}">
            </div>
        </div>
        <div class="col-lg-auto pt-2">
            <div class="input-group">
                ...
                id="brance-rays-governments" type="text" class="form-control" name="brance_rays_governments" value="{{$brance_rays_governments??$branch->getGovernments()}}" title="{{$lang->hint4}}" placeholder="{{ $lang->hint4 }}">
            </div>
        </div>
        <div class="col-lg-auto pt-2">
            <div class="input-group">
                ...
                id="brance-rays-city" type="text" class="form-control" name="brance_rays_city" value="{{$brance_rays_city??$branch->getCity()}}" title="{{$lang->hint5}}" placeholder="{{ $lang->hint5 }}">
            </div>
        </div>
        <div class="col-lg-auto pt-2">
            <div class="input-group">
                ...
                id="brance-rays-street" type="text" class="form-control" name="brance_rays_street" value="{{$brance_rays_street??$branch->getStreet()}}" title="{{$lang->hint6}}" placeholder="{{ $lang->hint6 }}">
            </div>
        </div>
        <div class="col-lg-auto pt-2">
            <div class="input-group">
                ...
                id="brance-rays-building" type="text" class="form-control" name="brance_rays_building" value="{{$brance_rays_building??$branch->getBuilding()}}" title="{{$lang->hint7}}" placeholder="{{ $lang->hint7 }}">
            </div>
        </div>
        <div class="col-lg-auto pt-2">
            <div class="input-group">
                ...
                id="brance-rays-address" type="text" class="form-control" name="brance_rays_address" value="{{$brance_rays_address??$branch->getAddress()}}" title="{{$lang->hint8}}" placeholder="{{ $lang->hint8 }}">
            </div>
        </div>
        <div class="col-lg-auto pt-2">
            <div class="input-group">
